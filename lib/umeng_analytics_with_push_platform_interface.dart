...
import 'umeng_analytics_with_push_method_channel.dart';

typedef OnMessageHandler = Future<void> Function(PushMessage);

class PushMessage {
  PushMessage.fromMap(this.payload);
...
abstract class UmengAnalyticsWithPushPlatform extends PlatformInterface {
  ...
  /// platform-specific class that extends [UmengAnalyticsWithPushPlatform] when
  ...
  Future<void> initialize({
    ...
    OnMessageHandler? onMessage, // APP在前台收到通知
    OnMessageHandler? onLaunch, // 启动
    OnMessageHandler? onResume, // 点击通知打开App
  });
