...
object UmengAnalyticsWithPush {
    ...
    fun preinitial(
        ...
        UMConfigure.preInit(
            ...
            getUmengAppKey(app),
            channel
        )// Should config in AndroidManifest.xml
    ...
    @JvmStatic
    fun initialize(
        context: Context, deviceType: Int? = null,
        ...
        // agent.setNotificationOnForeground(notificationOnForeground ?: true)
    ...
    private fun registerDevice(context: Context) {
        ...
        if (hasXiaomi && xiaomiAppId != null && xiaomiAppKey != null) {
            ...
            org.android.agoo.xiaomi.MiPushRegistar.register(
                context,
                xiaomiAppId.trim(),
                xiaomiAppKey.trim()
            )
            ...
            Log.w(
                TAG,
                "<meta-data android:name=\"com.xiaomi.push.app_id\" android:value=\"\" /> <meta-data android:name=\"com.xiaomi.push.app_key\" android:value=\"\" />"
            )
            Log.w(TAG, "*****************************************************")
        ...
        if (hasMeizu && meizuAppId != null && meizuAppKey != null) {
            org.android.agoo.mezu.MeizuRegister.register(
                context,
                meizuAppId.trim(),
                meizuAppKey.trim()
            )
            ...
            Log.w(
                TAG,
                "<meta-data android:name=\"com.meizu.push.app_id\" android:value=\"\" /> <meta-data android:name=\"com.meizu.push.app_key\" android:value=\"\" />"
            )
            Log.w(TAG, "*****************************************************")
        ...
        if (hasVivo && hasVivoAppId && hasVivoApiKey) {
            ...
            Log.w(
                TAG,
                "<meta-data android:name=\"com.vivo.push.app_id\" android:value=\"\" /> <meta-data android:name=\"com.vivo.push.api_key\" android:value=\"\" />"
            )
            Log.w(TAG, "*****************************************************")
        ...
        if (hasOppo && oppoAppKey != null && oppoAppSecret != null) {
            org.android.agoo.oppo.OppoRegister.register(
                context,
                oppoAppKey.trim(),
                oppoAppSecret.trim()
            )
            ...
            Log.w(
                TAG,
                "<meta-data android:name=\"com.oppo.push.app_key\" android:value=\"\" /> <meta-data android:name=\"com.oppo.push.app_secret\" android:value=\"\" />"
            )
            Log.w(TAG, "*****************************************************")
